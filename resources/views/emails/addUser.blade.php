                        ...
                        <td align='left' bgcolor='#ffffff'>
                            <table border='0' cellpadding='0' cellspacing='0' width='90%' style='margin:4px;'>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url('validate_email/'.Crypt::encryptString($user->id))}}"
                                         style="font-size: 13px;color: #fff; background-color: #007bff; border-color: #007bff; display: inline-block; text-align: center; padding: 0.375rem 0.75rem; border-radius: 0.25rem;">
                                          @lang('emails.confirm')
                                        </a>
                                    </td>
                                </tr>
