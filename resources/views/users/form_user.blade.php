    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <select name="type_doc" id="type_doc"  class="form-control" required>
        ...
        <div class="form-group  col-md-4">
            ...
            <input name="num_doc" type="text" maxlength="20" class="form-control" id="num_doc" placeholder="@lang('form.num_doc')" required>
        </div>
        <div class="form-group col-md-4">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4"  id="select-rol">
